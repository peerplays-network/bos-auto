...
class Testcases(unittest.TestCase):
    ...
    def test_dynamic_testCondition(self):
        _message = {
            ...
            "arguments": {
                "types": [
                    {"value": "-2", "participant": "Atlanta Hawks", "type": "1x2_hc"},
                    {"value": "8.5", "type": "ou"},
                ]
            },
            "provider_info": {
        ...
        _message["timestamp"] = (datetime.utcnow() - timedelta(hours=0.99)).strftime(
            "%Y-%m-%dT%H:%M:%SZ"
        )
        trigger = DynamicBmgTrigger(
            _message, lookup_instance=lookup, config=config, storage=self.storage
        ...
        _message["timestamp"] = (datetime.utcnow() - timedelta(hours=1.00)).strftime(
            "%Y-%m-%dT%H:%M:%SZ"
        )
        trigger = DynamicBmgTrigger(
            _message, lookup_instance=lookup, config=config, storage=self.storage
    ...
    def test_dynamic_ou(self):
        _message = {
            ...
            "call": "dynamic_bmgs",
            "arguments": {"types": [{"value": "8", "type": "ou"}]},
            "id": {
                "sport": "Basketball",
                "start_time": "2022-10-16T00:00:00Z",
                "home": "Atlanta Hawks",
        ...
        self.assertIn(
            ["en", "Under 8.5"], ops[0][1]["proposed_ops"][1]["op"][1]["description"]
        )
        self.assertIn(
            ["en", "Over 8.5"], ops[0][1]["proposed_ops"][2]["op"][1]["description"]
        )
    ...
    def test_dynamic_hc(self):
        _message = {
            ...
            "arguments": {
                "types": [
                    {"value": "-1", "participant": "Atlanta Hawks", "type": "1x2_hc"},
                    {"value": "-3", "participant": "Atlanta Hawks", "type": "1x2_hc"},
                ]
            },
            "provider_info": {
                "name": "foobar",
    ...
    def test_dynamic_hc2(self):
        ...
        _message = {
            ...
            "arguments": {
                "types": [
                    {"value": "-1", "participant": "Atlanta Hawks", "type": "1x2_hc"},
                    {"value": "-3", "participant": "Boston Celtics", "type": "1x2_hc"},
                ]
            },
            "provider_info": {
                "name": "foobar",
    ...
    def test_dynamic_hcou(self):
        ...
        self.assertIn(
            ["en", "Under 8.5"], ops[0][1]["proposed_ops"][4]["op"][1]["description"]
        )
        self.assertIn(
            ["en", "Over 8.5"], ops[0][1]["proposed_ops"][5]["op"][1]["description"]
        )
    ...
    def test_dynamic_ou_nohc(self):
        _message = {
            ...
            "arguments": {
                "types": [
                    {"value": "-2", "participant": "Brooklyn Nets", "type": "1x2_hc"},
                    {"value": "9", "type": "ou"},
                ]
            },
            "provider_info": {
        ...
        self.assertIn(
            ["en", "Under 9.5"], ops[0][1]["proposed_ops"][1]["op"][1]["description"]
        )
        self.assertIn(
            ["en", "Over 9.5"], ops[0][1]["proposed_ops"][2]["op"][1]["description"]
        )
    ...
    def test_dynamic_ou_fuzzy(self):
        ...
        _message = {
            ...
            "arguments": {"types": [{"value": "3.5", "type": "ou"}]},
            "provider_info": {
                "name": "",
                "beb_id": "452",
                "source_file": "20180624-000114_c7a7901b-2eae-4343-b4f7-075f0c79a067.json",
